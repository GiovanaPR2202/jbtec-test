...
var throttle = function (workers, tasks) { return __awaiter(void 0, void 0, void 0, function () {
    var results, runningTasks, currentIndex, runTask, i;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                runningTasks = [];
                currentIndex = 0;
                runTask = function () { return __awaiter(void 0, void 0, void 0, function () {
                    var taskIndex, task, result;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                            ...
                            case 1:
                                ...
                                results.push(result);
                                console.log(results);
                                if (!(currentIndex < tasks.length)) return [3 /*break*/, 3];
                ...
                for (i = 0; i < Math.min(workers, tasks.length); i++) {
                    runningTasks.push(runTask());
                }
                return [4 /*yield*/, Promise.all(runningTasks)];
            case 1:
                _a.sent();
